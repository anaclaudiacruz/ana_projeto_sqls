/* -- criação de database e use
 create database db_feriado;
 use db_feriado;
*/

/* -- criação da tbl_usuario
...
/* -- inserindo linhas em Agencia  

--insert into itmn330_agencia values
--(null, 0, 'TODAS');

insert into itmn330_agencia values 
(null,1010,'Butantan-USP'), 
(null,'2002','Jau'),
(null,3043,'Jabaquara'), 
(null,9823,'Pocos de Caldas'),
(null,7850,'Centro'),
(null,2315,'Av Ipiranga');
...
/* -- selects  em agencia, usuario
 select * from itmn330_agencia;
 select * from tbl_usuario;
 select * from itmn330_feriado;
 */
